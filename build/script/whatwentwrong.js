...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:whatwentwrong.c30e00d96da1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="First Button",c="execute",b="whatwentwrong.Application",a="whatwentwrong/test.png";
...
var g=new qx.ui.form.Button(d,a);
var f=this.getRoot();
f.add(g,{left:100,top:50});
g.addListener(c,function(e){alert("Hello World!");
});
}}});
})();
(function(){var n="execute",m="toolTipText",l="icon",k="label",j="qx.ui.core.MExecutable",h="value",g="qx.event.type.Event",f="_applyCommand",d="enabled",c="menu",a="changeCommand",b="qx.ui.core.Command";
qx.Mixin.define(j,{events:{"execute":g},properties:{command:{check:b,apply:f,event:a,nullable:true}},members:{__kH:null,__kI:false,__kJ:null,_bindableProperties:[d,k,l,m,h,c],execute:function(){var o=this.getCommand();

if(o){if(this.__kI){this.__kI=false;
}else{this.__kI=true;
o.execute(this);
}}this.fireEvent(n);
},__kK:function(e){if(this.__kI){this.__kI=false;
return;
}this.__kI=true;
this.execute();
},_applyCommand:function(p,q){if(q!=null){q.removeListenerById(this.__kJ);
}
if(p!=null){this.__kJ=p.addListener(n,this.__kK,this);
}var t=this.__kH;

if(t==null){this.__kH=t={};
}var u;
...
}},members:{__kL:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__kL;
},getMarkup:function(e){if(this.__kL){return this.__kL;
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__kL:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__kL;
},_applyStyle:function(){},getMarkup:function(){if(this.__kL){return this.__kL;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__kM=new qx.ui.decoration.css3.BorderImage();

if(p){this.__kN(p);
}}else{this.__kM=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__kM.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__kM:null,getMarkup:function(){return this.__kM.getMarkup();
},resize:function(r,s,t){this.__kM.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__kM.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__kM[y](w);
},_applyBaseImage:function(z,A){if(this.__kM instanceof qx.ui.decoration.GridDiv){this.__kM.setBaseImage(z);
}else{this.__kN(z);
}},__kN:function(B){var G,H,J,I;
this.__kM.setBorderImage(B);
...
this.__kM.setSlice([N,D,E,O]);
}},destruct:function(){this.__kM.dispose();
this.__kM=null;
}});
})();
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__kL:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__kL;
...
this.__kL=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__kL;
